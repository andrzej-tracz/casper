                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="gender" class="form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}" name="gender">
                                        <option selected value="">{{ __('General') }}</option>
                                        @foreach(\App\Casper\Model\Gender::getValidValues() as $gender)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="birth_date" type="date" class="form-control{{ $errors->has('birth_date') ? ' is-invalid' : '' }}" name="birth_date" min="1900-01-01" max="{{ \Carbon\Carbon::now()->subDay()->format('Y-m-d') }}"/>
